...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://zoran.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
    ...
    deleteImage(imageType) {
        axios.delete(`https://api.devcamp.space/portfolio/delete-portfolio-blog-image/${this.props.blog.id}?image_type=${imageType}`, { withCredentials: true })
            .then(response => {
                this.props.handleFeatImgDel();
               console.log("response from blog image delete", reponse);
            }).catch(error => {
    ...
    handleSubmit(event) {
        ...
        .then(response => {
            ...
            if (this.props.editMode) {
                this.props.handleUpdateFormSub(response.data.portfolio_blog);
            } else {
                ...
                <input 
                    ...
                    />
                        ...
                        {this.props.editMode && this.props.blog.featured_image_url ? ( 
                            <div className="port-man-img-wrapper">
